...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(Math.round(random(windowWidth, 350),40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(windowWidth, 350),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(windowWidth, 350),40, 10, 10));
...
console.log(World.frameCount)
    var sword = createSprite(Math.round(random(windowWidth, 350),40, 10, 10));
